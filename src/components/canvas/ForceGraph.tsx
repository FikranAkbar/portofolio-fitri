        ...
        <div className="max-w-[640px] mx-auto px-8 py-12 flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-5">
              ...
              {TESTIMONIALS.map(t => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[32px] leading-none text-[#E73AA4]/20 font-serif group-hover:text-[#E73AA4]/40 transition-colors duration-300 -mt-1">"</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#E73AA4]/20 to-[#E73AA4]/5 flex items-center justify-center shrink-0">
                      <span className="text-[13px] font-semibold text-[#E73AA4]">{t.initial}</span>
                    </div>
                    <div className="flex flex-col gap-0">
                      <span className="text-[14px] font-semibold text-gray-800">{t.name}</span>
                      <span className="text-[12px] text-gray-400">{t.flag} {t.country}</span>
                    </div>
                    ...
                    <div className="ml-auto flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                      <span className="text-[11px] text-gray-400">via Fiverr</span>
                      <svg className="w-3 h-3 text-gray-300" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
            ...
            >
              ...
              <svg className="w-3.5 h-3.5 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
                <path d="M2.5 9.5L9.5 2.5M9.5 2.5H4.5M9.5 2.5V7.5"/>
              </svg>
            </a>
          </div>
